...
def row_from_reports(model: str, layout: dict, arch: dict | None, dxf: dict | None) -> dict:
    return {
        ...
        "gt_overlap_ratio_mean": get_nested(layout, ["summary", "gt_overlap_ratio", "mean"]),
        "overlap_excess_ratio_mean": get_nested(layout, ["summary", "overlap_excess_ratio", "mean"]),
        "overlap_delta_abs_mean": get_nested(layout, ["summary", "overlap_delta_abs", "mean"]),
...
def main() -> None:
    ...
    fields = [
        ...
        "adj_f1_mean",
        "overlap_ratio_mean",
        "gt_overlap_ratio_mean",
        "overlap_excess_ratio_mean",
        "overlap_delta_abs_mean",
